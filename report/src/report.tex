...
\cite{REF}.\\
This report presents an algoritm to track circular red, blue, and green robots 
...
as an appendix). Section \ref{results} evaluates the algorithm's performance
under a number of different capture conditions. The results and possible avenues
for improvement are discussed in Section \ref{discussion}.
